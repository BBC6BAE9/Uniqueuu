...
class YMActionSheet: UIView {
    ...
    class func show() {
        ...
        actionSheet.backgroundColor = UNColor(r:0, g: 0, b: 0, a: 0.6)
    ...
    private lazy var shareLabel: UILabel = {
        ...
        shareLabel.text = "分享到"
        shareLabel.textColor = UNColor(r: 0, g: 0, b: 0, a: 0.7)
    ...
    private lazy var cancelButton: UIButton = {
        ...
        cancelButton.setTitleColor(UNColor(r: 37, g: 142, b: 240, a: 1.0), for: .normal)
