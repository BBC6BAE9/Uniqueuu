...
class YMCategoryHeaderViewController: UNBaseViewController {
    ...
    override func viewDidLoad() {
        ...
        setupUI()
        /// 分类界面 顶部 专题合集
        UNNetworkTool.shareNetworkTool.loadCategoryCollection(limit: 6) { (collections) in
    ...
    private func setupUI() {
        ...
        collectionView.register(cellNib, forCellWithReuseIdentifier: "YMCategoryCollectionViewCell")
